...
const Index = () => {
  ...
  const services = [
    {
      icon: "Lightbulb",
      title: "Полировка фар",
      description: "Профессиональная полировка помутневших фар с восстановлением прозрачности до 95%"
    },
    {
      icon: "Wrench",
      title: "Ремонт трещин",
      description: "Качественный ремонт сколов и трещин с использованием современных материалов"
    },
    {
      icon: "Shield",
      title: "Защитное покрытие",
      description: "Нанесение защитного лака для долговременной защиты от помутнения"
    },
    {
      icon: "Sparkles",
      title: "Восстановление",
      description: "Полное восстановление оптики после ДТП или длительной эксплуатации"
    }
  ];
  ...
  const prices = [
    { service: "Полировка одной фары", price: "от 1 500 ₽" },
    { service: "Полировка двух фар", price: "от 2 500 ₽" },
    { service: "Ремонт трещины", price: "от 2 000 ₽" },
    { service: "Защитное покрытие (пара)", price: "от 1 000 ₽" },
    { service: "Полное восстановление (пара)", price: "от 4 500 ₽" }
  ];
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Ремонт Фар</span>
          </div>
        ...
        <div className="container px-4">
          <div className="mx-auto max-w-3xl text-center text-white animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Профессиональный ремонт автомобильных фар
            </h1>
            <p className="text-lg md:text-xl mb-8 text-gray-200">
              Восстановим прозрачность и яркость ваших фар за 1-2 часа. Гарантия качества на все виды работ.
            </p>
        ...
        <div className="container px-4">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Профессиональный подход и современное оборудование для качественного результата
            </p>
          </div>
